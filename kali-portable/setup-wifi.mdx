...
description: "setup-wifi.sh enables monitor mode on a USB WiFi adapter inside Kali Portable, killing conflicting processes and printing the new interface name."
---
