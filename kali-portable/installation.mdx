...
description: "Step-by-step guide to installing Kali Portable using the automated installer script. Handles Docker, NVIDIA GPU, image build, and wordlist downloads automatically."
---
...
<Tip>
  The Dockerfile is structured in 21 named stages. If a specific layer fails (e.g., a GitHub release URL changes), you can comment out that block, rebuild, and add the tool manually inside the container later.
</Tip>
