---
title: "BorazuwarahCTF: Steganography and SSH Brute Force"
sidebarTitle: "BorazuwarahCTF"
description: "Writeup for BorazuwarahCTF on DockerLabs: extract hidden credentials from an image using steghide, brute-force SSH with Hydra, and escalate with sudo."
---
...
<Steps>
  <Step title="Enumerate Sudo Permissions">
    ...
    **Output:**
    ...
    This is an extremely dangerous misconfiguration: the user can run `/bin/bash` as any user — including root — with no restrictions.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="sudo bash = Root Access" icon="shield-exclamation">
