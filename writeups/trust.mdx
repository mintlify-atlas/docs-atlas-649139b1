...
sidebarTitle: "trust"
description: "Writeup for the trust DockerLabs machine (Very Easy): enumerate a web server to find credentials, gain SSH access, and escalate privileges using a sudo misconfiguration."
---
